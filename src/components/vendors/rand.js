...
// Define the category options with logo paths
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow mt-[6%] px-4 sm:px-6 md:px-8 pt-8 xl:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4 gap-8 lg:gap-12 xl:gap-16 mb-16 mt-12">
